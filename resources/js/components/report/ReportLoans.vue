                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="basicSelect4" v-model="filter.status">
                                            <option value="">--</option>
                                            <option value="N">Dipinjam</option>
                                            <option value="Y">Dikembalikan</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
    ...
    methods: {
        ...
        openExecute(){
            ...
            if(!check){
                ...
                table.ajax.url("/report/loans-rpt?menufn="+ this.$route.name +"&"+ urlParam ).load();
            }
        },
        ...
        openXLS(){
            ...
            if(!check){
                ...
                .then((response) => {
                    ...
                    link.href = url;
                    link.setAttribute('download', 'Laporan Pinjaman Buku ' + this.filter.date + '.xlsx');
