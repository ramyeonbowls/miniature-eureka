...
export default {
    ...
    mounted() {
        ...
        table = $('#data_rst').DataTable({
            ...
            pageLength: 25,
            processing: true,
            ajax: "/report/read-fitur-rpt?nodata=yes",
            columns: [
                ...
                { data: "fitur", class: "text-center text-nowrap" },
                { data: "title", class: "text-center text-nowrap" },
                { data: "reader", class: "text-center text-nowrap" }
            ],
            language: {
                lengthMenu: "_MENU_",
                search: "_INPUT_",
    ...
    methods: {
        ...
        openExecute(){
            ...
            if(!check){
                ...
                table.ajax.url("/report/read-fitur-rpt?menufn="+ this.$route.name +"&"+ urlParam ).load();
            }
        },
        ...
        openXLS(){
            ...
            if(!check){
                ...
                .then((response) => {
                    ...
                    link.href = url;
                    link.setAttribute('download', 'Laporan Pembaca Fitur ' + this.filter.date + '.xlsx');
