...
export default {
    ...
    mounted() {
        ...
        table = $('#data_rst').DataTable({
            ...
            pageLength: 25,
            processing: true,
            ajax: "/report/readbook-user-rpt?nodata=yes",
            columns: [
                ...
                { data: "dibaca", class: "text-center text-nowrap" },
    ...
    methods: {
        ...
        openExecute(){
            ...
            if(!check){
                ...
                table.ajax.url("/report/readbook-user-rpt?menufn="+ this.$route.name +"&"+ urlParam ).load();
            }
        },
        ...
        openXLS(){
            ...
            if(!check){
                ...
                .then((response) => {
                    ...
                    link.href = url;
                    link.setAttribute('download', 'Laporan Baca Buku User ' + this.filter.date + '.xlsx');
