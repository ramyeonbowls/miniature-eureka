            ...
            if(this.selected.length > 0) {
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        window.axios.delete('/setting/tajuk-utama-mst/'+ this.selected[0].id +'?menufn='+ this.$route.name)
                            .then(response => {
                                loader.hide();
                                this.selected = [];
                                table.ajax.reload();
                ...
                this.$refs.form.validate().then(result => {
                    if(result.valid) {
                        ...
                        if(this.form.new) {
                            ...
                            window.axios.post('/setting/tajuk-utama-mst?menu_fn='+ this.$route.name, form_data)
                                .then((response) => {
                                    loader.hide();
                                    this.cancel();
                            ...
                            window.axios.post('/setting/tajuk-utama-mst/'+ this.form.field.id +'?menu_fn='+ this.$route.name, form_data)
                                .then((response) => {
                                    loader.hide();
                                    this.cancel();
