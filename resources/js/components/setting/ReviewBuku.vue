                                                            ...
                                                            <form class="form form-horizontal" @submit.prevent="handleSubmit($event, submit)">
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-10 form-group">
                                                                            <Field name="file">
                                                                                <input type="file" ref="reviewbuku_files" id="file" name="file" @change="onChangeIcon" accept=".png,.jpg,.jpeg" />
                                                                            </Field>
...
export default {
    ...
    methods: {
        ...
        clearForm() {
            ...
            this.$refs.reviewbuku_files.value = '';
            this.quill.setText('');
        },

        async onChangeIcon(e) {
            this.form.field.file = this.$refs.reviewbuku_files.files[0];
        },
