...
use App\Exports\Report\OfflineVisitorsReportExport;
use App\Services\Report\OfflineVisitorsReportService;
use Yajra\DataTables\Facades\DataTables;

class OfflineVisitorsReportController extends Controller
{
    private OfflineVisitorsReportService $visitors_service;
    ...
    public function __construct()
    {
        ...
        $this->visitors_service = new OfflineVisitorsReportService();
    }
    ...
    public function ExportXLS(Request $request)
    {
        ...
        return Excel::download(new OfflineVisitorsReportExport($results), 'Laporan_Pengunjung_Offline.xlsx');
    }
}
