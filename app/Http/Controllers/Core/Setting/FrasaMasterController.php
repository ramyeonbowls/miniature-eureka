...
use App\Services\Setting\FrasaMasterService;
use App\Http\Requests\Setting\StoreFrasaMasterRequest;
use App\Http\Requests\Setting\UpdateFrasaMasterRequest;

class FrasaMasterController extends Controller
{
    private FrasaMasterService $Frasa_service;
    ...
    public function __construct()
    {
        ...
        $this->Frasa_service = new FrasaMasterService();
    }
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $results = $this->Frasa_service->get();
     ...
     * @return JsonResponse
     */
    public function store(StoreFrasaMasterRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $created = $this->Frasa_service->store((object)$validated);
            if ($created) {
     ...
     *
     * @param UpdateFrasaMasterRequest $request
     * @param string $id
     * @return JsonResponse
     */
    public function update(UpdateFrasaMasterRequest $request, string $id): JsonResponse
    {
        try {
            $validated = $request->validated();
            // Rest of your logic
        ...
        try {
            ...
            $updated = $this->Frasa_service->update((object)$validated, $id);
            if ($updated) {
    ...
    public function destroy(string $id): JsonResponse
    {
        ...
        try {
            ...
            $deleted = $this->Frasa_service->delete($id);
