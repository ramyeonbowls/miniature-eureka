...
class ReadBookContentExport implements WithCustomStartCell, WithHeadings, WithTitle, WithEvents, ShouldAutoSize
{
    private $data;
    ...
    {
        return 'Laporan Baca Buku Content';
    }
    ...
    public function registerEvents(): array
    {
        return [
            BeforeExport::class => function(BeforeExport $event) {
                $event->writer->getProperties()->setTitle( 'Laporan Baca Buku Content' );
            ...
            AfterSheet::class => function(AfterSheet $event) {
                ...
                foreach ($this->data as $val) {
                    ...
                    $event->sheet->setCellValue('E'.$row, $val['pembaca']);
